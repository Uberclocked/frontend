                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            className="bg-[#2b3740] text-[#F5F5DC] border-gray-600"
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        {fields.map((field, index) => (
                            <div
                                key={index}
                                className="grid grid-cols-5 gap-2 items-center bg-[#2b3740] p-2 rounded"
                            >
                                <Input
                                    value={field.name}
                                    onChange={(e) =>
                    ...
                    <Button onClick={handleSubmit} className="w-full bg-[#FF8000]">
                        Save changes
                    </Button>
                </div>
            </DialogContent>
