...
export default function ProductCarousel() {
    ...
    return (
        <div className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-xl shadow-lg bg-[#2b3740]">
            <div className="flex items-center justify-center p-10 gap-10 transition-all duration-700 ease-in-out">
                ...
                <div className="text-[#F5F5DC] max-w-sm">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            className="px-5 py-2 border border-[#F5F5DC] text-[#F5F5DC] rounded hover:bg-[#F5F5DC] hover:text-[#36454F]"
                        >
                            Add to cart
                        </button>
                    </div>
