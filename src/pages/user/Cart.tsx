...
export default function CartPage() {
    ...
    if (!cart) {
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
                <p className="text-gray-200 text-lg">Error loading cart</p>
            </div>
        );
    }
            ...
            <div className="mx-auto max-w-5xl">
                ...
                {items.length === 0 ? (
                  ...
                  {Math.min(visibleCount, items.length)}
                                ...
                                of{" "}
                                <span className="text-gray-100 font-semibold">{items.length}</span>{" "}
                                items
                            </p>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <select
                                    ...
                                    className="rounded-xl border border-gray-800 bg-gray-900 px-3 py-2 text-gray-100"
                                >
                                    {[4, 6, 8, 12, 999].map((n) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {visibleItems.map((item: any) => {
                                ...
                                return (
                                    <div
                                        key={item.id}
                                        className="p-4 rounded-2xl bg-gray-900 border border-gray-800 shadow-sm"
                                    >
                                        <div className="flex gap-4">
                                            <div className="h-20 w-20 rounded-xl overflow-hidden border border-gray-800 bg-gray-950 flex items-center justify-center">
                                                <img
                                                    src={imageSrc}
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {item.productName && (
                                                    <p className="text-gray-300 text-sm mt-1">
                                                        Product: <span className="text-gray-200">{item.productName}</span>
                                                    </p>
                                                )}
                                                ...
                                                {isCustomPc && (
                                                    <div className="mt-3 flex flex-col gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-fit px-3 py-2 rounded-xl bg-[#FF8000] text-black hover:bg-[#e67300]"
                                                        >
                                                            Modify PC
                                                        </button>
                                                    </div>
                                                ...
                                                <div className="flex flex-wrap items-center gap-3 mt-4">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <button
                                                            ...
                                                            className="h-9 w-9 rounded-xl border border-gray-700 text-gray-200 hover:bg-gray-800 disabled:opacity-40"
                                                        ...
                                                        <div className="min-w-10 text-center text-gray-100 font-semibold">
                                                            {item.quantity}
                                                        </div>
                                                    ...
                                                    <button
                                                        ...
                                                        className="ml-auto px-3 py-2 rounded-xl text-gray-100 border border-gray-700 hover:bg-gray-800 transition-colors disabled:opacity-40"
                                                        disabled={isUpdating}
                                                    >
                                                        Remove
                                                    </button>
                        ...
                        <div className="flex justify-center">
                            <button
                                onClick={doCheckout}
                                className="mt-8 px-6 py-3 rounded-2xl text-white text-lg font-bold bg-[#FF8000] hover:bg-orange-600 transition-colors"
                            >
                                Pay
                            </button>
                        </div>
