...
function statusBadgeClass(status: string) {
    ...
    return "bg-gray-800 text-[#F5F5DC] text-sm px-3 py-1";
}
        ...
        return (
            <div className={shell}>
                <div className="mx-auto max-w-3xl space-y-4">
                    <div className={card}>
                        <p className="text-[#F5F5DC]">Post not found.</p>
                    </div>
                    <Button
                        asChild
                        className="bg-[#FF8000] text-black hover:bg-[#e67300]
                ...
                <div className={card}>
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-6">
                        ...
                        <div className="flex-1 min-w-0 space-y-2">
                            <h1 className="text-2xl font-bold text-[#F5F5DC]">{post.title}</h1>
                            ...
                            <p className="mt-4 text-[#F5F5DC] whitespace-pre-wrap leading-relaxed">
                                {post.description}
                            </p>
                        ...
                        <div className="shrink-0">
                            {imgSrc ? (
                                <img
                                    ...
                                    alt={post.title}
                                    loading="lazy"
                                    className="h-28 w-28 rounded-xl object-cover border border-gray-800"
                                />
                            ) : (
                                <div className="h-28 w-28 rounded-xl border border-gray-800 bg-gray-950 flex items-center justify-center">
