      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex items-end justify-between gap-4">
          ...
          <div className="rounded-2xl border px-4 py-3">
            <p className="text-sm">Estimated total (cached)</p>
            ...
            {SLOTS.map((slot) => {
              ...
              return (
                <button
                  ...
                  className="group rounded-3xl border p-6 transition flex flex-col items-center justify-center text-center"
                >
                  <p className="font-semibold">{slot.label}</p>

                  {sku ? (
                    <>
                      <p className="mt-2 text-xs">{sku}</p>
                      <p className="mt-1 text-xs line-clamp-2">{p?.name ?? "Selected"}</p>
                    </>
                  ) : (
                    <p className="mt-2 text-xs">Type: {slot.componentSkuPrefix}</p>
                  )}
                </button>
              );
            })}
          ...
          <DialogContent className="max-w-3xl border">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center">
              ...
              <div className="text-sm">
                Type: <span className="font-semibold">{active?.componentSkuPrefix ?? "-"}</span>
              </div>
            </div>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm">{p.skuPrefix}</p>
                          <p className="text-sm">
